...
function MyForm() {
  ...
  const [name, setName] = useState("Zaid Kashan");
  // getter setter
  console.log(name)
  return (
    <div className="bg-white min-h-screen w-full flex justify-center items-center">
      <button onClick={()=>setName("Hammad")} className="p-3 bg-red-500 text-white">Click me</button>
      {/* <form className="flex flex-col space-y-1 w-[50%] border p-5 bg-gray-100 rounded-[15px]">
        ...
        <div>
          <input className="p-2 rounded-[6px]" type="radio" name="radio" />
        </div>
        ...
        <input
          className="border p-2 rounded-[10px] bg-red-500 text-white"
          type="submit"
          value={"submit"}
        />
      </form> */}
